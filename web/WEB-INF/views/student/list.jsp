                            ...
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="sno" name="sno" placeholder="请输入学号关键字" value="${sno}">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label>&nbsp;</label>
                                                    <a href="${pageContext.request.contextPath}/student/edit" class="btn btn-success btn-block">添加学生</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <%
                                            try {
                                                PagerVO<Student> pager = (PagerVO<Student>)request.getAttribute("pager");
                                        ...
                                        <tr>
                                            ...
                                            <td><%= s.getEnterdate() != null ? s.getEnterdate() : "" %></td>
                                            <td>
                                                <div class="btn-group">
                                                    <a class="btn btn-xs btn-default" href="${pageContext.request.contextPath}/student/edit?sno=<%= s.getSno() %>" title="编辑" data-toggle="tooltip"><i class="mdi mdi-pencil"></i></a>
                                                    <a class="btn btn-xs btn-default delete-btn" href="javascript:void(0);" data-sno="<%= s.getSno() %>" title="删除" data-toggle="tooltip"><i class="mdi mdi-window-close"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <%
                                        ...
                                        %>
                                        <tr>
                                            <td colspan="7" class="text-center">没有找到匹配的学生记录</td>
                                        </tr>
                                        <%
                                            }
                                        } catch (Exception e) {
                                ...
                                <jsp:include page="../_pager.jsp">
                                    <jsp:param name="pageUrl" value="${pageContext.request.contextPath}/student" />
                                </jsp:include>
                            </div>
                        </div>
                    </div>
